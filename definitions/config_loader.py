...
class ConfigLoader:
    ...
    def __init__(
        ...
        error_handler: Any,
        validation_manager: Optional[ConfigValidationManager] = None,
    ...
    def load_all_configs(self, strategy: str) -> Tuple[Dict[str, YamlToObject], Dict[str, Any]]:
        ...
        if strategy in ["basic_seller", "gui"]:
            configs["basic_seller"] = self._load_and_update_config("config_basic_seller.yaml")
    ...
    def _load_yaml_file(self, file_path: str, yaml: YAML) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.error_handler.handle(
                e,
                context={"file_path": file_path, "operation": "load_yaml"}
            )
            return None
    ...
    def _validate_config(self, config_type: str, user_config: Dict[str, Any], config_path: str) -> None:
    ...
    def _log_validation_result(self, config_type: str, validation_result: ValidationResult) -> None:
