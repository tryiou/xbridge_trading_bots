                    ...
                    if values[0] == key:
                        new_values = [
                            ...
                            pair.dex_order.get('status',
                                               'None') if self.parent.started and pair.dex_order and 'status' in pair.dex_order else 'Disabled' if pair.disabled else 'None',
                            pair.current_order.get('side',
                                                   'None') if self.parent.started and pair.dex_order and 'status' in pair.dex_order else 'None',
                            self.parent.get_flag(pair.dex_order.get('status',
                                                                    'None') if self.parent.started and pair.dex_order and 'status' in pair.dex_order else 'None'),
                            str(pair.variation) if self.parent.started and pair.dex_order and 'status' in pair.dex_order else 'None'
                        ]
