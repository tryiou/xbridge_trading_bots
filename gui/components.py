...
class AddSellerDialog(tk.Toplevel):
    def __init__(self, parent, config: 'GUI_Config_BasicSeller'):
        super().__init__(parent)
        self.title("Add New Seller Instance")
        self.result = None
        self.config = config
        ...
        self.offset_var = tk.StringVar(value="0.015")
...
class SellerConfigDialog(tk.Toplevel):
    def __init__(self, parent: tk.Toplevel, values: tuple, config: 'GUI_Config_BasicSeller') -> None:
        ...
        self.name_var = tk.StringVar(value=values[0])
        self.pair_var = tk.StringVar(value=values[2])
        self.amount_var = tk.StringVar(value=values[3])
        self.min_price_var = tk.StringVar(value=values[4])
        self.offset_var = tk.StringVar(value=values[5])
